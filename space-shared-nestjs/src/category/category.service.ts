...
export class CategoryService {
    ...
    async getAll(): Promise<EditCategoryDto[]> {
        return this.classMapper.mapArrayAsync(await this.categoryRepository.find(), Category, EditCategoryDto);
    }

    async getById(id: string): Promise<EditCategoryDto> {
        return this.classMapper.mapAsync(await this.categoryRepository.findOneBy({_id: ObjectID(id) }), Category, EditCategoryDto);
    }
    ...
    async create(category: CreateCategoryDto): Promise<EditCategoryDto> {
        ...
        return this.classMapper.mapAsync(await this.categoryRepository.save(entity), Category, EditCategoryDto);
    }
