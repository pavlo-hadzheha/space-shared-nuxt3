...
export class SpaceService {
    ...
    async getAll(): Promise<ViewSpaceDto[]> {
        return this.classMapper.mapArrayAsync(await this.spaceRepository.find(), Space, ViewSpaceDto);
    ...
    async getById(id: string): Promise<ViewSpaceDto> {
        return this.classMapper.mapAsync(await this.spaceRepository.findOneBy({_id: ObjectID(id) }), Space, ViewSpaceDto);
    ...
    async create(space: CreateSpaceDto, user: User): Promise<EditSpaceDto> {
        ...
        return this.classMapper.mapAsync(await this.spaceRepository.save(entity), Space, EditSpaceDto);
    }
